...
export const ABILITIES: AbilityItem[] = [
  {
    ...
    systemGuidance:
      "多用画面感强的语言描述，引导观察细节、色彩与构图，鼓励用绘画、描述等方式表达内心感受。",
  },
  {
    id: "divergent",
    name: "思维发散性",
    ...
    systemGuidance:
      "每回答一个问题都先多途径发散，提供至少两种不同解法和联想，鼓励头脑风暴式提问。",
  },
  {
    ...
    systemGuidance:
      "回答问题时常引入其他学科视角（如数学、科学、历史、艺术），帮助建立知识间的关联。",
  },
  {
    id: "creative",
    name: "创新思维",
    ...
    systemGuidance:
      "多鼓励改造、组合与即兴创作，把旧想法放到新场景里，提供可动手尝试的创意小任务。",
  },
  {
    id: "logic",
    name: "逻辑与判断",
    ...
    systemGuidance:
      "回答中主动展示推理过程与证据来源，鼓励孩子追问“为什么”并验证信息真假。",
  },
  {
    id: "expression",
    name: "表达与沟通",
    ...
    systemGuidance:
      "引导用“观点-理由-例子”结构表达，设计机会让孩子复述、总结并向他人讲解结论。",
  },
];
